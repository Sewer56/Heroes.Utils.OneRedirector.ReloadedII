...
namespace SonicHeroes.Utils.OneRedirector
{
    ...
    {
        private OneFileTracker _oneFileTracker;

        private ILogger _logger;
        private Config _configuration;
        private OneBuilderCollection _builderCollection;
        private Dictionary<string, VirtualOne> _virtualOneFiles = new Dictionary<string, VirtualOne>(StringComparer.OrdinalIgnoreCase);
        private HashSet<string> _modFolders = new HashSet<string>();
